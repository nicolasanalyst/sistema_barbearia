import { initializeApp } from "https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js";
        ...
        const loadTimeSlots = async (dateStr) => {
            ...
            // ========================================================
            // ALTERAÇÃO: VERIFICAÇÃO DE DOMINGO
            // ========================================================
            const [y, m, d] = dateStr.split('-').map(Number);
            // Cria data usando construtor (ano, mes-1, dia) para evitar problemas de timezone
            const checkDate = new Date(y, m - 1, d);

            if (checkDate.getDay() === 0) { // 0 = Domingo
                addBotMessage(`⚠️ <b>A barbearia não abre aos domingos (${d}/${m}).</b><br>Por favor, selecione outro dia.`, 'date_selector');
                // Não prossegue para carregar horários
                return;
            }
            // ========================================================
